...
// ui elem: [15 bits: reserved][1 bit: in-world][16 bits: z]
layout (location = 2) in uint data3;
// ui elem: [8 bits: texture x][8 bits: texture y][8 bits: reserved][8 bits: char]
layout (location = 3) in uint data4;
// ui elem: [4 bits: 0][1 bit: s][1 bit: u][1 bit: i][1 bit: b][4 bits: fgc][4 bits: bgc][8 bits: fga][8 bits: bga]
uniform vec2 fbsize;
